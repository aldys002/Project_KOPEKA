...
<head>
    ...
    <style>
        ...
        /* Dropdown Style ala Screenshot lo */
        .dropdown-menu { 
        ...
        /* Hero Section dengan Gambar Kereta */
        .hero-section {
            position: relative;
            height: 85vh;
            /* Pastikan file foto ada di public/images/kereta.jpg */
            background: url("{{ asset('images/kereta.jpg') }}") no-repeat center center;
        ...
        .hero-overlay {
            ...
            background: linear-gradient(to right, rgba(0, 51, 153, 0.8), rgba(237, 107, 35, 0.4));
            z-index: 1;
        }
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-train me-2"></i>KOPEKA
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-4">
                        <a href="{{ route('login') }}" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm" style="background: var(--kai-blue); border: none;">DOWNLOAD APLIKASI</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <h4 class="text-warning mt-3 fw-bold">021-21242525</h4>
                    <p class="small opacity-75">Jl. Perintis Kemerdekaan, Bandung</p>
                </div>
            </div>
